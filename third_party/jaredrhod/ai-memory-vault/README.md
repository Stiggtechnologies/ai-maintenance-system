...
**Already inside a Claude Code session?** Paste this and it builds the whole system with you: _"I'd like to set this up, please: https://github.com/jaredrhod/ai-memory-vault.git"_
