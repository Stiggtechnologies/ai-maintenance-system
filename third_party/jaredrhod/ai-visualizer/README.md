...
**The easy way to configure it:** open this folder in Claude Code and say _"read ai-visualizer.md and set me up."_ The wizard picks your face, your agent's name, and wires your voice line with you.

**Already in a Claude Code session with your agent?** One sentence does the whole install: _"clone https://github.com/jaredrhod/ai-visualizer.git, then read ai-visualizer/ai-visualizer.md and set me up."_ Your agent clones it, runs the wizard, and wires it in for you.
