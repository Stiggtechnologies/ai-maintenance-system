...
**The easy way to configure it:** open this folder in Claude Code and say _"read backtalk.md and set me up."_ The wizard picks your agent folder, your key, and your voice with you, then test-fires the whole loop.

**Already in a Claude Code session with your agent?** One sentence does the whole install: _"clone https://github.com/jaredrhod/backtalk.git, then read backtalk/backtalk.md and set me up."_ Your agent runs the installer and the wizard for you.
