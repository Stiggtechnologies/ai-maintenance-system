/**
 * @deprecated Legacy dashboard service layer.
 *
 * Canonical services for new development:
 * - platform.ts — user context, sign out
 * - performance.ts — OEE, KPI values (via RPCs)
 * - work.ts — work orders, notifications, backlog (via RPCs)
 * - governance.ts — approvals, audit events, recommendations
 * - syncaiDataService.ts — organization, assets, KPIs, OEE, work orders, recommendations
 *
