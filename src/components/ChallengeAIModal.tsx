      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-[8%] mx-auto max-w-lg max-h-[85vh] overflow-y-auto bg-[#0E1520] border border-white/8 rounded-2xl z-50 shadow-2xl"
          ...
          >
            {submitted ? (
              ...
              <>
                ...
                {recommendation && (
                  <div className="mx-6 mt-4 p-3 rounded-xl bg-white/3 border border-white/6">
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 rounded-xl border transition-all text-sm ${
                          selectedReason === reason.id
                            ...
                            : "bg-white/2 border-white/6 text-slate-400 hover:bg-white/4 hover:border-white/10"
                        }`}
                      >
                        {reason.label}
                      </button>
                ...
                <div className="px-6 pb-4">
                  <textarea
                    ...
                    className="w-full h-20 px-4 py-3 bg-white/3 border border-white/6 rounded-xl text-sm text-slate-200 placeholder-slate-600 resize-none focus:outline-hidden focus:border-teal-500/40 transition-colors"
                  />
                </div>
