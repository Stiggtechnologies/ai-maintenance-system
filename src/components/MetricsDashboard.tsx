...
export function MetricsDashboard() {
  ...
  const calculateCostMetrics = (costs: any[]) => {
    ...
    costs.forEach((c) => {
      if (c.model_name) {
        byModel[c.model_name] =
          (byModel[c.model_name] || 0) + (c.total_cost || 0);
      }
    });
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 border border-purple-200">
          ...
          <div className="text-3xl font-bold text-purple-900">
            {metrics.throughput.runsPerHour.toFixed(1)}
          </div>
            ...
            <div>
              ...
              <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min((metrics.latency.p50 / metrics.latency.p99) * 100, 100)}%`,
                  }}
                />
              </div>
            </div>
            <div>
              ...
              <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min((metrics.latency.p95 / metrics.latency.p99) * 100, 100)}%`,
                  }}
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-semibold text-green-900">
                  {metrics.throughput.successRate.toFixed(0)}%
                </span>
              </div>
            </div>
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              <span className="text-sm text-slate-400">Runs/Hour</span>
              <span className="text-lg font-semibold text-blue-900">
