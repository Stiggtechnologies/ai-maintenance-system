...
export function WarRoomDashboard() {
  ...
  const loadMetrics = async () => {
    ...
    const criticalCount =
      incidents?.filter((i) => i.CriticalityLevel === "Critical").length || 0;
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-3 h-3 rounded-full ${getStatusColor(incident.status)} animate-pulse`}
                          />
                          <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="text-white font-medium">
                        {selectedIncident.asset_name}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-gray-400 mb-1">Severity</div>
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-xs font-medium border ${getSeverityColor(selectedIncident.severity)}`}
                      >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${getStatusColor(selectedIncident.status)}`}
                        />
