...
describe("PresenceFace", () => {
  it.each(PRESENCE_PHASES)("renders the %s phase from conversation state", (phase) => {
  ...
  it("does not claim plant execute or copy a circuit-board clone", () => {
    ...
    expect(container.innerHTML).not.toMatch(/circuit|jarvis|openclaw|authorize plant/i);
  });
});
