...
export function PlansAndPricing() {
  ...
  const fetchPlans = async () => {
    try {
      ...
      const response = await fetch(
        `${supabaseUrl}/functions/v1/billing-api/plans`,
        {
          headers: {
  ...
  const handleSelectPlan = async (planCode: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `${supabaseUrl}/functions/v1/stripe-checkout/checkout`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${supabaseKey}`,
            ...
            <div>
              <div className="bg-teal-50 rounded-lg p-4 mb-3">
                ...
                <p className="text-sm text-teal-700">
                  Fixed monthly fee for your plan tier, includes base asset and
                  credit allowance
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="bg-blue-50 rounded-lg p-4 mb-3">
                ...
                <p className="text-sm text-blue-700">
                  Pay per additional asset beyond your included limit at your
                  plan's asset rate
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="bg-purple-50 rounded-lg p-4 mb-3">
                ...
                <p className="text-sm text-purple-700">
                  Credits consumed beyond monthly allowance billed at your
                  plan's overage rate
                </p>
              </div>
            </div>
