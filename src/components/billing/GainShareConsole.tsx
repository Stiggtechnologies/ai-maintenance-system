  ...
  const handleCreateRun = async () => {
    try {
      ...
      const response = await fetch(
        `${supabaseUrl}/functions/v1/billing-gainshare`,
        {
          method: "POST",
          headers: {
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400">
              Performance-based billing based on operational improvements
            </p>
          </div>
          <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <p className="text-slate-300">
                We establish baseline KPIs for availability, MTBF, MTTR, and
                costs
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Calculate financial impact of performance gains over evaluation
                period
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                You pay 10-20% of documented savings as performance fee
              </p>
            </div>
          </div>
        </div>
        ...
        {runs.length === 0 ? (
          <div className="bg-[#11161D] rounded-xl border border-[#232A33] p-12 text-center">
            ...
            <p className="text-slate-400">
              Create your first calculation to see performance-based fees
            </p>
          </div>
        ) : (
                ...
                {run.report?.savings_breakdown && (
                  <div className="pt-4 border-t border-[#232A33]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                      {Object.entries(run.report.savings_breakdown).map(
