...
export const hydraulicMiningShovelTemplate: AssetClassTemplate = {
  ...
  description:
    "Governed component, failure, telemetry, and inspection foundation for large hydraulic mining shovels.",
  functions: [
    "dig",
    "crowd",
    "hoist",
  ...
  components: [
    {
      ...
      functions: [
        ...
        "maintain geometry",
        "transfer attachment and propel loads",
      ],
      telemetryConcepts: [
        "cycle_count",
        "structural_strain",
      ...
      failureModes: [
        draftFailure(
          ...
          "fatigue",
          ["cyclic loading", "stress concentration", "impact"],
          ["loss of structural capacity", "geometry change"],
          ["drone_rgb", "drone_thermal", "drone_lidar", "inspection"],
          [
    ...
    },
    {
      ...
      failureModes: [
        draftFailure(
          "HMS-ATTACH-WEAR",
          "HMS-ATTACH",
          "Pin, bushing, or wear-surface degradation",
          "wear",
          ["abrasion", "lubrication loss", "misalignment", "impact"],
          ["excess clearance", "load redistribution", "reduced control"],
          ["inspection", "drone_rgb", "vibration"],
          ["dimensional_inspection", "qualified_engineering_inspection"],
          4,
        ),
      ],
    },
    {
      ...
      functions: [
        ...
        "control pressure",
        "actuate digging and steering functions",
        "reject heat",
      ],
      telemetryConcepts: [
        "system_pressure",
      ...
      failureModes: [
        draftFailure(
          ...
          "wear",
          ["contamination", "overheating", "cavitation", "seal deterioration"],
          [
            "loss of force",
    ...
    },
    {
      ...
      failureModes: [
        draftFailure(
          "HMS-DRIVE-DEGRADE",
          "HMS-SWING-PROPEL",
          "Swing or propel drivetrain degradation",
          "wear",
          ["lubrication loss", "contamination", "misalignment", "overload"],
          [
            "abnormal heat",
            "vibration",
            "loss of movement or holding capability",
          ],
          ["vibration", "oil_analysis", "drone_thermal", "inspection"],
          [
    ...
    },
    {
      ...
      failureModes: [
        draftFailure(
          "HMS-ELEC-HOT-CONNECTION",
          "HMS-ELEC-CTRL",
          "High-resistance electrical connection",
          "thermal degradation",
          ["looseness", "contamination", "corrosion", "conductor damage"],
          ["thermal damage", "arc fault", "loss of function"],
