...
export const extendedElectricRopeShovelComponents: ComponentTemplate[] = [
  {
    ...
    functions: [
      "penetrate and retain material",
      "release payload",
      "transfer digging loads",
    ],
    telemetryConcepts: [
      "dipper_position",
      "door_state",
  ...
  },
  {
    ...
    functions: [
      "translate machine",
      "support ground loads",
      "steer by differential motion",
    ],
    telemetryConcepts: [
      "propel_current",
      "propel_speed",
  ...
  },
  {
    ...
    functions: [
      ...
      "hold mechanisms stationary",
      "provide fail-safe restraint",
    ],
    telemetryConcepts: [
      "brake_command",
      "brake_release_state",
