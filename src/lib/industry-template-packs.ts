...
export interface IndustryTemplatePack {
  ...
  /**
   * The ladder means something or it means nothing. 'customer_validated'
   * requires a NAMED customer having exercised the pack and signed off —
   * fifteen packs carried it on a platform with one customer, which made the
   * ladder decorative. Reset to 'draft' 2026-08-11; only evidence moves a pack
   * up, and no code path may promote one.
   */
...
export const INDUSTRY_TEMPLATE_PACKS = {
  oil_sands: {
    ...
    description:
      "Bitumen extraction operations including SAGD (Steam-Assisted Gravity Drainage), surface mining, and upgrading facilities with emphasis on environmental stewardship, abrasive service management, winterization, and tailings pond integrity.",
    primaryMissionObjective:
      "Maximize bitumen production while maintaining environmental compliance, equipment reliability, and safe operations in extreme climate conditions.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Scheduled maintenance program with quarterly inspections",
      minimumForOptimization:
        "Optimized - Predictive maintenance with integrated sensor networks",
    },
  ...
  mining: {
    ...
    industryName: "Mining",
    description:
      "Open pit and underground mining operations including mineral processing, ore handling, and beneficiation with emphasis on production throughput, dust control, mobile fleet reliability, and personnel safety in hazardous environments.",
    primaryMissionObjective:
      "Extract mineral ore at maximum sustainable throughput while maintaining safety, environmental compliance, and equipment reliability in challenging geological conditions.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Preventive maintenance schedule with weekly inspections",
      minimumForOptimization:
        "Optimized - Real-time fleet telematics with predictive diagnostics",
    },
    regulatoryConsiderations: [
  ...
  oil_gas: {
    ...
    description:
      "Upstream, midstream, and downstream petroleum operations including wellhead production, pipeline transportation, and processing with emphasis on integrity management, process safety, and PSM (Process Safety Management) compliance.",
    primaryMissionObjective:
      "Safely and reliably produce, transport, and process hydrocarbons while maintaining regulatory compliance and operational integrity across all pressure boundaries.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Annual pipeline inspection, quarterly equipment verification",
      minimumForOptimization:
        "Optimized - Continuous monitoring with real-time analytics",
    },
    regulatoryConsiderations: [
  ...
  petrochemical: {
    ...
    description:
      "Refinery, chemical plant, and specialty chemical operations with emphasis on process safety, management of change (MOC), corrosion under insulation (CUI), and hazardous chemical handling.",
    primaryMissionObjective:
      "Operate chemical plants safely and continuously while managing process hazards, maintaining catalyst activity, and ensuring product quality and regulatory compliance.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Daily process monitoring with weekly equipment verification",
      minimumForOptimization:
        "Optimized - Real-time analytics with predictive maintenance",
    },
    regulatoryConsiderations: [
  ...
  battery_energy_storage: {
    ...
    industryName: "Battery & Energy Storage",
    description:
      "Stationary and mobile electrochemical energy-storage systems governed around thermal management, high-voltage safety, measured degradation, fire barriers, grid/service continuity, and evidence-backed human authorization.",
    primaryMissionObjective:
      "Deliver the required energy and power service without exceeding organization-approved electrical, thermal, electrochemical, or fire-safety envelopes.",
    commonAssetClasses: [
      "Battery Cells, Modules, Racks, and Strings",
      "Battery Management Systems",
      "Power Conversion Systems",
      "Thermal Management Systems",
      "High-Voltage Contactors and Protection",
      "Energy Management and Supervisory Controls",
      "Fire Detection, Ventilation, and Suppression",
      "Transformers, Switchgear, and Grid Interconnection",
    ],
    onboardingQuestions: [
      "Which battery chemistries, cell formats, and controlled configurations are installed?",
      "What service is provided: backup, peak shaving, frequency response, propulsion, or another approved duty?",
      "Which manufacturer- or authority-approved voltage, current, temperature, state-of-charge, and state-of-health limits apply?",
      "How are cell/module temperatures, voltage imbalance, insulation, ground faults, and protective trips recorded?",
      "Which high-voltage isolation, lockout, arc-flash, emergency shutdown, and responder controls are approved?",
      "Which fire detection, off-gas detection, ventilation, propagation, suppression, and emergency plans apply?",
      "What capacity, impedance/resistance, cycle, calendar-age, and duty-history evidence is available?",
      "Who holds technical authority for continued service, repair, isolation, recommissioning, and emergency disposition?",
    ],
    criticalityModel: {
      riskMatrix:
        "Organization-approved Electrical-Thermal-Fire-Service-Environmental Matrix",
      consequenceCategories: [
        "Personnel Electrical or Arc-Flash Harm",
        "Thermal Event or Fire Propagation",
        "Toxic or Flammable Gas Release",
        "Loss of Required Energy Service",
        "Environmental or Hazardous-Material Release",
        "Equipment and Property Damage",
      ],
      likelihoodScale:
        "Organization-approved likelihood scale supported by chemistry, configuration, duty, and event evidence",
      criticalityThresholds: {
        low: null,
        medium: null,
        high: null,
    ...
    riskDrivers: [
      "Cell or module temperature excursion and thermal propagation",
      "High-voltage isolation, ground-fault, contactor, or protection failure",
      "Capacity fade, resistance growth, imbalance, and power-limit reduction",
      "BMS sensing, estimation, communications, configuration, or firmware failure",
      "Cooling/heating loss or non-uniform airflow/coolant distribution",
      "Fire/off-gas detection, ventilation, suppression, or emergency-response impairment",
      "Duty, charging, ambient, storage, or maintenance exposure outside the approved envelope",
    ],
    safeguards: [
      "Cell/module voltage and temperature monitoring with governed alarm and trip provenance",
      "Approved high-voltage isolation, overcurrent, ground-fault, interlock, and emergency-stop functions",
      "Controlled BMS configuration, firmware, calibration, and change records",
      "Thermal management condition monitoring and verified degraded-mode response",
      "Fire/off-gas detection, ventilation, propagation controls, responder information, and drills",
      "Capacity and impedance/resistance testing under a controlled method with traceable instruments",
    ],
    approvalGates: [
      "Initial Energization — Electrical and Battery Technical Authority",
      "Protection or BMS Change — Engineering, Cybersecurity, and Configuration Review",
      "Continued Service after Limit Excursion — Battery Safety Technical Authority",
      "Repair or Module Replacement — Qualified Procedure and Recommissioning Approval",
      "Return after Fire, Off-Gas, Thermal, or Isolation Event — Emergency and Engineering Authority",
      "Operating-Envelope or Duty Change — Design, Safety, and Service-Owner Approval",
    ],
    failureModeFocusAreas: [
      "Cell internal short, external short, overheating, and thermal propagation",
      "Capacity loss, resistance growth, lithium plating, imbalance, or chemistry-specific degradation",
      "BMS sensor drift, estimation error, communications loss, firmware, or configuration defect",
      "High-voltage isolation loss, contactor weld/failure, ground fault, arc, or protection miscoordination",
      "Power-conversion failure, harmonic/thermal stress, or loss of commanded charge/discharge",
      "Cooling/heating component failure, leakage, blockage, fouling, or non-uniform thermal control",
      "Fire/off-gas detection, ventilation, suppression, containment, or emergency-response impairment",
    ],
    kpiModel: {
      primaryKpis: [
        ...
        "High-Voltage Protection Demand and Failure",
        "Fire-Safety Barrier Readiness",
        "State-of-Health Evidence Coverage",
      ],
      secondaryKpis: [
        "Cell or Module Temperature Spread",
        "Cell Voltage Imbalance",
        "Measured Capacity Retention",
        "Measured Resistance or Impedance Change",
        "Cooling-System Availability",
        "Protective Trip and Alarm Test Compliance",
        "Unresolved Battery Safety Actions",
      ],
      kpiTargets: {},
    },
    readinessModel: {
      readinessLevels: [
        "Unverified — configuration, limits, or safety evidence incomplete",
        "Controlled — approved envelope, protection, procedures, and inspection evidence established",
        "Condition-informed — traceable thermal, electrical, and degradation evidence supports decisions",
        "Optimized — governed service and maintenance changes are verified against realized outcomes",
      ],
      minimumForOperation:
        "Controlled — the responsible authority defines the approved operating envelope and required safeguards",
      minimumForOptimization:
        "Condition-informed — controlled observations and approved criteria support degradation and duty decisions",
    },
    regulatoryConsiderations: [
      "Applicable electrical, fire, building, environmental, transport, workplace-safety, and grid requirements",
      "Jurisdiction- and installation-specific adopted code editions and authority decisions",
      "Chemistry-, product-, and manufacturer-specific listings, instructions, and approved limits",
      "Hazardous-material, damaged-battery, storage, transport, recycling, and disposal controls",
      "Emergency response coordination and responder-access requirements",
    ],
    dataSourcesRequired: [
      "Controlled asset, chemistry, cell/module, firmware, and protection configuration",
      "BMS/EMS voltage, current, temperature, SOC/SOH, alarm, trip, and event history",
      "Thermal management flows, pressures, temperatures, commands, and availability",
      "Capacity, impedance/resistance, insulation, ground-fault, contactor, and protection test records",
      "Duty cycles, energy throughput, charge/discharge rate, ambient, storage, and outage history",
      "Fire/off-gas detection, ventilation, suppression, inspection, impairment, and drill evidence",
      "Approved operating envelope, maintenance basis, emergency plan, and authority dispositions",
    ],
    integrationTargets: [
      "Battery and energy management systems",
      "Power conversion and grid supervisory controls",
      "Thermal management controls and condition monitoring",
      "Electrical protection, relays, meters, and test systems",
      "Fire/off-gas detection, ventilation, suppression, and building systems",
      "CMMS/EAM, incident, evidence, configuration, and emergency-management records",
    ],
    outputArtifacts: [
      "Battery Operating-Envelope and Evidence-Gap Assessment",
      "Thermal Distribution and Cooling Readiness Review",
      "High-Voltage Protection and Isolation Verification",
      "Capacity/Resistance Degradation Trend and Service-Margin Screen",
      "Fire Barrier, Impairment, and Emergency-Readiness Review",
      "Human-Approved Continued-Service, Isolation, Repair, or Recommissioning Decision Record",
    ],
    confidenceRules: [
      "No generic chemistry threshold substitutes for an approved asset-specific criterion",
      "Measurements identify instrument, calibration, method, timestamp, unit, and controlled configuration",
      "SOC/SOH estimates identify algorithm/version and are not treated as direct measurements",
      "Degradation comparisons use compatible method, temperature, SOC, duty, and configuration bases",
      "Safety-barrier status requires current test or inspection evidence and named authority disposition",
      "Missing or stale evidence produces an explicit gap, never a passing default",
    ],
    blockedAutomationRules: [
      "Do not authorize energization, continued operation, return to service, or recommissioning",
      "Do not override BMS, protection, interlocks, isolation, alarms, trips, ventilation, or suppression",
      "Do not infer safe voltage, current, temperature, SOC, SOH, capacity, resistance, or fire limits",
      "Do not automatically change charging, discharging, balancing, thermal, or protection setpoints",
      "Do not automatically reset or re-energize after a thermal, fire, off-gas, ground-fault, or isolation event",
      "Do not certify code, listing, grid, transport, hazardous-material, or fire-safety compliance",
    ],
    templateVersion: "1.0.0",
    validationStatus: "draft",
  },
  ...
  power_generation: {
    ...
    description:
      "Thermal, hydroelectric, wind, and solar power generation facilities with emphasis on grid reliability, dispatch consistency, regulatory compliance, and generation availability.",
    primaryMissionObjective:
      "Reliably generate electrical power to meet grid demand and contractual obligations while maintaining environmental compliance and operational efficiency.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Quarterly equipment inspections and planned maintenance",
      minimumForOptimization:
        "Optimized - Continuous monitoring with predictive algorithms",
    },
    regulatoryConsiderations: [
  ...
  utilities: {
    ...
    description:
      "Water supply, wastewater treatment, and gas distribution networks with emphasis on service continuity, public health protection, and regulatory compliance.",
    primaryMissionObjective:
      "Continuously deliver safe, reliable utility services to customer base while maintaining infrastructure integrity and regulatory compliance.",
    commonAssetClasses: [
      "Water Treatment Plants",
    ...
    criticalityModel: {
      riskMatrix:
        "5x5 Public Health-Service Continuity-Environmental-Safety Impact",
      consequenceCategories: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Monthly inspections and preventive maintenance schedule",
      minimumForOptimization:
        "Optimized - Real-time monitoring with automated leak detection",
    },
    regulatoryConsiderations: [
  ...
  manufacturing: {
    ...
    description:
      "Discrete and process manufacturing facilities with emphasis on overall equipment effectiveness (OEE), changeover performance, product quality, and production line balancing.",
    primaryMissionObjective:
      "Maximize production output and quality while minimizing downtime and waste through optimized equipment performance and efficient line balancing.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Daily equipment verification with scheduled PM",
      minimumForOptimization:
        "Optimized - Real-time OEE analytics with predictive maintenance",
    },
    regulatoryConsiderations: [
  ...
  food_beverage: {
    ...
    description:
      "Food processing, dairy, and brewing operations with emphasis on HACCP compliance, sanitation standards, allergen management, and cold chain integrity.",
    primaryMissionObjective:
      "Produce safe, high-quality food and beverage products while maintaining HACCP compliance, hygiene standards, and cold chain integrity.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Daily sanitation procedures and weekly environmental testing",
      minimumForOptimization:
        "Optimized - Continuous temperature and ATP monitoring",
    },
    regulatoryConsiderations: [
  ...
  pharmaceuticals: {
    ...
    description:
      "GMP-regulated pharmaceutical production facilities with emphasis on product validation, cGMP compliance, deviation management, CAPA implementation, and batch integrity.",
    primaryMissionObjective:
      "Produce pharmaceuticals in full compliance with cGMP regulations while maintaining product quality, batch integrity, and traceability.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Quarterly equipment qualification and validated methods",
      minimumForOptimization:
        "Optimized - Continuous monitoring with predictive quality analytics",
    },
    regulatoryConsiderations: [
  ...
  transportation_logistics: {
    ...
    description:
      "Fleet management, rail, and port operations with emphasis on schedule reliability, vehicle availability, and personnel safety in transportation environments.",
    primaryMissionObjective:
      "Reliably deliver goods on schedule while maintaining fleet availability, operator safety, and compliance with transportation regulations.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Pre-trip inspections with monthly maintenance schedule",
      minimumForOptimization:
        "Optimized - Real-time telematics with predictive maintenance",
    },
    regulatoryConsiderations: [
  ...
  aviation: {
    ...
    description:
      "Maintenance, repair, and overhaul (MRO) operations and fleet maintenance with emphasis on airworthiness certification, airworthiness directive (AD) compliance, minimum equipment list (MEL) adherence, and dispatch reliability.",
    primaryMissionObjective:
      "Maintain fleet airworthiness and dispatch reliability while ensuring full compliance with airworthiness directives and regulatory certification.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Compliance with scheduled check intervals and AD requirements",
      minimumForOptimization:
        "Optimized - Predictive analytics with real-time component monitoring",
    },
    regulatoryConsiderations: [
  ...
  marine_shipping: {
    ...
    description:
      "Vessel maintenance, port operations, and shipping fleet management with emphasis on class society rules compliance, dry-dock planning, SOLAS regulations, and vessel availability.",
    primaryMissionObjective:
      "Maintain vessel classification and seaworthiness while optimizing fleet utilization and meeting international maritime regulations.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Scheduled maintenance per dry-dock intervals and SOLAS requirements",
      minimumForOptimization:
        "Optimized - Continuous monitoring with predictive maintenance planning",
    },
    regulatoryConsiderations: [
  ...
  data_centers: {
    ...
    description:
      "Critical infrastructure data center operations with emphasis on uptime tier compliance, redundancy assurance, thermal management, and uninterruptible power systems.",
    primaryMissionObjective:
      "Deliver continuous IT infrastructure services with guaranteed uptime and compliance with tier certifications while maintaining redundancy and thermal stability.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Weekly equipment verification and monthly preventive maintenance",
      minimumForOptimization:
        "Optimized - Continuous monitoring with predictive redundancy validation",
    },
    regulatoryConsiderations: [
  ...
  defense: {
    ...
    description:
      "Military equipment sustainment and maintenance operations with emphasis on operational availability, mission-capable rate, and depot-level readiness.",
    primaryMissionObjective:
      "Maintain defense equipment and systems at optimal operational readiness to support mission requirements and force deployment.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Scheduled maintenance per military maintenance schedules",
      minimumForOptimization:
        "Optimized - Predictive analytics with continuous monitoring",
    },
    regulatoryConsiderations: [
  ...
  healthcare: {
    ...
    description:
      "Hospitals, ambulatory facilities and clinical support services with governed clinical-engineering evidence for medical-device reliability, availability, calibration, infection-control readiness and traceability. The pack never makes a diagnosis or replaces clinical, infection-prevention, biomedical-engineering or regulatory authority.",
    primaryMissionObjective:
      "Keep clinical technology available, traceable and fit for its authorized purpose while protecting patient safety and preserving human clinical authority.",
    commonAssetClasses: [
      "Life-Support and Critical-Care Devices",
      "Diagnostic Imaging Systems",
      "Patient Monitoring Systems",
      "Infusion and Medication Delivery Devices",
      "Sterilization and Reprocessing Equipment",
      "Laboratory and Point-of-Care Equipment",
      "Medical Gas and Clinical Utility Systems",
      "Clinical Information and Device Integration Systems",
    ],
    onboardingQuestions: [
      "Which facilities, care settings, clinical services and device populations are in scope?",
      "Which clinical functions and patient consequences govern device criticality?",
      "Which manufacturer instructions, authority requirements and local policies apply?",
      "Which devices require calibration, preventive maintenance or reprocessing evidence before use?",
      "How are device identity, configuration, location, service history and recalls traced?",
      "Which current impairments, overdue activities or availability constraints affect care delivery?",
      "Who holds clinical, infection-prevention, biomedical-engineering and return-to-service authority?",
      "Which CMMS, device, calibration, reprocessing and incident systems can provide bounded evidence?",
    ],
    criticalityModel: {
      riskMatrix: "Organization-approved Patient-Safety-Clinical-Service-Compliance Matrix",
      consequenceCategories: [
        "Patient Harm",
        "Loss of Critical Clinical Service",
        "Infection Prevention and Control",
        "Regulatory or Accreditation Non-Compliance",
        "Device or Data Traceability Failure",
      ],
      likelihoodScale:
        "Organization-defined likelihood scale requiring authorized clinical adoption",
      criticalityThresholds: { low: null, medium: null, high: null, critical: null },
    },
    riskDrivers: [
      "Failure or unavailability of clinically critical devices",
      "Calibration drift or measurement uncertainty",
      "Incomplete cleaning, disinfection or sterilization evidence",
      "Uncontrolled device configuration or software change",
      "Weak device identity, location, maintenance or recall traceability",
      "Deferred maintenance and unresolved safety communications",
    ],
    safeguards: [
      "Approved clinical-criticality and alternative-care review",
      "Manufacturer-authorized maintenance and calibration procedures",
      "Infection-prevention-approved reprocessing methods and release evidence",
      "Unique device identity, controlled configuration and complete service history",
      "Current safety communication, recall and incident-review processes",
      "Independent biomedical-engineering and clinical return-to-service approval",
    ],
    approvalGates: [
      "Scope, Device Population and Clinical Criticality Approval",
      "Applicable Requirement and Manufacturer Instruction Review",
      "Maintenance or Calibration Method Approval",
      "Infection Prevention and Reprocessing Release",
      "Patient-Risk and Alternative-Care Review",
      "Biomedical Engineering and Clinical Return-to-Service Authorization",
    ],
    failureModeFocusAreas: [
      "Loss of life-support, monitoring or therapy availability",
      "Sensor, analyser or delivery-system calibration drift",
      "Battery, power-supply and alarm-system failure",
      "Reprocessing-cycle failure or incomplete release evidence",
      "Software, network, interface or configuration incompatibility",
      "Device misidentification, location loss or incomplete service history",
      "Unresolved recall, safety notice or repeat incident",
    ],
    kpiModel: {
      primaryKpis: [
        "Clinically Critical Device Availability",
        "Patient-Safety-Critical Maintenance Compliance",
        "Calibration Compliance",
        "Infection-Control Release Evidence Coverage",
        "Open High-Criticality Device Impairments",
        "Device Traceability Completeness",
        "Repeat Device Incident Rate",
      ],
      secondaryKpis: [
        "Mean Time to Restore Clinical Service",
        "Overdue Manufacturer Safety Actions",
        "Alternative Device Coverage",
        "No-Fault-Found Service Event Share",
        "Configuration Baseline Coverage",
        "Return-to-Service Evidence Completeness",
      ],
      kpiTargets: {
        "Clinically Critical Device Availability": "Organization-approved target required",
        "Calibration Compliance": "Applicable requirement and approved tolerance required",
        "Infection-Control Release Evidence Coverage": "Infection-prevention authority criterion required",
        "Device Traceability Completeness": "Organization-approved completeness criterion required",
      },
    },
    readinessModel: {
      readinessLevels: [
        "Evidence gap - scope, authority or governing requirements are incomplete",
        "Controlled - device identity, criticality, responsibilities and required activities are governed",
        "Integrated - clinical, maintenance, calibration and reprocessing evidence share canonical identities",
        "Optimized - verified outcomes support governed availability and risk decisions",
      ],
      minimumForOperation:
        "Controlled - authorized criticality, maintenance, calibration, reprocessing and release responsibilities are recorded",
      minimumForOptimization:
        "Integrated - quality-assured device, service, calibration, incident and availability history is sufficient",
    },
    regulatoryConsiderations: [
      "Applicable medical-device, health-facility, occupational-safety and privacy requirements",
      "Manufacturer instructions for use and authorized service information",
      "Accreditation, infection prevention and reprocessing requirements",
      "Calibration traceability and measurement-system requirements",
      "Recall, safety communication and adverse-event obligations",
      "No jurisdiction, clinical rule, maintenance interval or acceptance threshold is presumed",
    ],
    dataSourcesRequired: [
      "Medical-device inventory, unique identity, configuration and location records",
      "CMMS work, inspection, preventive-maintenance and repair history",
      "Calibration certificates, standards, uncertainty and disposition records",
      "Approved cleaning, disinfection and sterilization cycle/release records",
      "Clinical service requirements, availability history and alternative-device plans",
      "Incident, recall, safety communication and return-to-service evidence",
    ],
    integrationTargets: [
      "Healthcare technology management or CMMS platform",
      "Device inventory and unique-device-identification systems",
      "Calibration and metrology systems",
      "Sterile processing and reprocessing record systems",
      "Clinical engineering incident and safety-notice systems",
      "Document and controlled-procedure management systems",
    ],
    outputArtifacts: [
      "Governed Clinical Device Criticality Register",
      "Clinical Service Availability and Alternative-Coverage View",
      "Calibration Assurance and Exception Register",
      "Infection-Control Readiness Evidence Pack",
      "Patient-Risk Device Decision Case",
      "Device Identity, Configuration and Service Trace",
      "Human-Approved Return-to-Service Record",
    ],
    confidenceRules: [
      "Every conclusion must bind to canonical device and evidence identities",
      "Criticality and patient consequence require named clinical authority approval",
      "Calibration results require traceable standards, method, date and disposition",
      "Reprocessing readiness requires an approved method and current release evidence",
      "Availability calculations require an explicit population, observation window and service-state definition",
      "Patient-level identifiers are excluded from specialist inputs and outputs",
    ],
    blockedAutomationRules: [
      "Do not diagnose, recommend treatment or prioritize one patient over another",
      "Do not declare a medical device safe, sterile, calibrated or fit for clinical use",
      "Do not invent clinical criticality, calibration tolerance, reprocessing method or maintenance interval",
      "Do not change device configuration, alarms, therapy parameters or clinical workflows",
      "Do not authorize deferral, substitution, release or return to service",
      "Do not ingest or emit patient-identifying information in specialist calculations",
    ],
    templateVersion: "1.0.0",
    validationStatus: "draft",
  },
  ...
  aerospace_launch: {
    ...
    description:
      "Launch vehicle and satellite operations with emphasis on countdown readiness, launch commit criteria, and mission assurance for space operations.",
    primaryMissionObjective:
      "Achieve reliable and repeatable launch operations while maintaining mission assurance, safety, and compliance with aerospace regulations.",
    commonAssetClasses: [
    ...
    readinessModel: {
      ...
      minimumForOperation:
        "Managed - Pre-flight checkout per flight readiness review requirements",
      minimumForOptimization:
        "Optimized - Integrated systems health with automated anomaly detection",
    },
    regulatoryConsiderations: [
  ...
  civil_infrastructure: {
    ...
    industryName: "Civil Infrastructure",
    description:
      "Owner-managed bridges, tunnels, roads, drainage, retaining structures and related public infrastructure, with condition, inspection, deterioration, load, geographic-hazard and renewal evidence governed without replacing the engineer of record or public authority.",
    primaryMissionObjective:
      "Sustain safe and serviceable civil infrastructure through traceable inspection, condition, restriction and renewal decisions based on approved engineering evidence.",
    commonAssetClasses: [
      ...
      "Transit, Rail and Pedestrian Structures",
      "Foundations, Embankments and Geotechnical Works",
    ],
    onboardingQuestions: [
      "Which infrastructure owners, jurisdictions, networks, assets and service corridors are in scope?",
      "Which inspection manuals, rating systems, load models and professional authorities apply?",
      "What canonical asset identity, location, geometry, material and configuration records are available?",
      "Which current inspections, defects and critical findings require follow-up?",
      "Which approved deterioration models and observation histories are valid for each asset population?",
      "Which load ratings, postings, closures or operating restrictions are current?",
      "Which flood, seismic, scour, landslide, wildfire or climate-hazard layers are authority-approved?",
      "Which renewal candidates, mandatory obligations, costs, dependencies and service consequences are governed?",
    ],
    criticalityModel: {
      riskMatrix: "Owner-approved Public-Safety-Service-Environment-Asset Matrix",
      consequenceCategories: [
        "Public and Worker Safety",
        "Loss of Essential Network Service",
        "Regulatory or Owner Non-Compliance",
        "Environmental or Community Consequence",
        "Structural Integrity and Renewal Exposure",
      ],
      likelihoodScale: "Owner-defined likelihood scale requiring qualified approval",
      criticalityThresholds: { low: null, medium: null, high: null, critical: null },
    },
    riskDrivers: [
      "Structural deterioration, section loss, cracking, fatigue and connection distress",
      "Scour, erosion, settlement, instability and hydraulic exceedance",
      "Inspection gaps, inconsistent ratings and unresolved critical findings",
      "Changed loading, configuration, condition or legal-load requirements",
      "Flood, seismic, landslide, wildfire, freeze-thaw and climate exposure",
      "Deferred renewal, access constraints and network dependency",
    ],
    safeguards: [
      "Qualified inspection with approved procedures, intervals and quality control",
      "Canonical asset, component, defect, location and configuration identities",
      "Engineer-approved rating, deterioration and load-analysis methods",
      "Critical-finding escalation and verified corrective-action evidence",
      "Authority-controlled restriction, posting, closure and reopening decisions",
      "Governed capital prioritization that preserves mandatory safety work",
    ],
    approvalGates: [
      "Asset Scope, Configuration and Criticality Approval",
      "Inspection Method, Rating Scale and Evidence Acceptance",
      "Deterioration Model and Parameter Approval",
      "Load Analysis and Restriction Authority Review",
      "Geographic Hazard Layer and Scenario Approval",
      "Qualified Renewal Decision and Owner Authorization",
    ],
    failureModeFocusAreas: [
      "Deck, superstructure, substructure or connection deterioration",
      "Fatigue, fracture, corrosion, delamination or material loss",
      "Scour, erosion, settlement, slope movement or foundation instability",
      "Pavement distress, rutting, cracking and loss of serviceability",
      "Drainage blockage, hydraulic capacity loss and flood damage",
      "Tunnel lining, ventilation, fire/life-safety or water-ingress failure",
      "Load-rating invalidation, missing posting or uncontrolled restriction",
    ],
    kpiModel: {
      primaryKpis: [
        "Critical Findings Open",
        "Qualified Inspection Compliance",
        "Condition Rating Evidence Coverage",
        "Load Rating and Posting Currency",
        "High-Criticality Deficiency Backlog",
        "Geographic Hazard Assessment Coverage",
        "Mandatory Renewal Commitment Coverage",
      ],
      secondaryKpis: [
        "Inspection Finding Closure Time",
        "Deterioration Forecast Verification Error",
        "Repeat Defect Rate",
        "Network Detour or Service Consequence",
        "Renewal Estimate Evidence Completeness",
        "Restriction Implementation Verification",
      ],
      kpiTargets: {
        "Qualified Inspection Compliance": "Applicable owner or authority requirement required",
        "Condition Rating Evidence Coverage": "Owner-approved coverage criterion required",
        "Load Rating and Posting Currency": "Qualified load-rating authority criterion required",
        "Mandatory Renewal Commitment Coverage": "Owner-approved obligation rule required",
      },
    },
    readinessModel: {
      readinessLevels: [
        "Evidence gap - asset scope, authority or governing method is incomplete",
        "Controlled - identities, inspection responsibilities and restrictions are governed",
        "Integrated - condition, loading, hazard, service and renewal evidence share canonical identities",
        "Optimized - verified histories support governed forecasts and portfolio decisions",
      ],
      minimumForOperation:
        "Controlled - current qualified inspections, critical-finding process and restriction authority are established",
      minimumForOptimization:
        "Integrated - sufficient quality-assured condition, loading, hazard and cost history exists",
    },
    regulatoryConsiderations: [
      "Applicable infrastructure inspection, reporting and owner requirements",
      "Professional engineering authentication and engineer-of-record authority",
      "Load rating, legal loading, permit loading, posting and closure requirements",
      "Environmental, watercourse, land-use, accessibility and worker-safety obligations",
      "Emergency management, public notification and network continuity responsibilities",
      "No jurisdiction, rating, interval, load, hazard threshold or service limit is presumed",
    ],
    dataSourcesRequired: [
      "Canonical asset inventory, location, geometry and controlled drawings",
      "Qualified inspection, defect, material-test and non-destructive-evaluation records",
      "Approved condition ratings, critical findings and corrective actions",
      "Load models, rating analyses, postings, permits and restriction records",
      "Approved geographic hazard layers and event/exposure histories",
      "Deterioration observations, renewal estimates, dependencies and service consequences",
    ],
    integrationTargets: [
      "Infrastructure asset management or CMMS platform",
      "Inspection and bridge/tunnel inventory systems",
      "GIS and approved hazard-data repositories",
      "Structural analysis and load-rating record systems",
      "Document, drawing and professional-seal repositories",
      "Capital planning and network operations systems",
    ],
    outputArtifacts: [
      "Governed Structural Condition and Defect Register",
      "Inspection Rating and Critical-Finding Trace",
      "Evidence-Bounded Deterioration Forecast",
      "Load Rating, Posting and Restriction Evidence Pack",
      "Geographic Hazard Exposure and Data-Quality View",
      "Mandatory-First Renewal Decision Case",
    ],
    confidenceRules: [
      "Every result must bind to canonical asset, component, inspection and evidence identities",
      "Ratings require the approved scale, qualified inspector, observation date and review status",
      "Deterioration forecasts require an approved model, parameters, calibration window and applicability boundary",
      "Load screens require a current qualified analysis and cannot establish or change a legal limit",
      "Geographic risk requires approved layers, coordinate reference, resolution, vintage and overlap method",
      "Renewal ranking keeps mandatory work outside economic deferral and exposes evidence gaps",
    ],
    blockedAutomationRules: [
      "Do not certify structural safety, condition compliance or fitness for service",
      "Do not invent inspection ratings, deterioration rates, load limits, hazard thresholds or renewal weights",
      "Do not post, restrict, close, reopen or route traffic",
      "Do not replace qualified inspection, load rating or engineer-of-record analysis",
      "Do not defer mandatory safety or regulatory work based on economics",
      "Do not authorize design, repair, expenditure or return to service",
    ],
    templateVersion: "1.0.0",
    validationStatus: "draft",
  },
