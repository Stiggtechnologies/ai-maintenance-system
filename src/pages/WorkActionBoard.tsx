        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2">
              ...
              <span
                className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${status.bg} ${status.color} border ${status.border}`}
              >
                {status.label}
              </span>
            </div>
            ...
            {expanded && (
              <div className="mt-3 pt-3 border-t border-white/[0.05] space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div>
                    <span className="text-slate-600">Production Impact: </span>
