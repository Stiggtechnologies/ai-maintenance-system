...
const GUARD = "20261005090100_engineering_signature_definer_only.sql";
/** The repair that closed four defects in GUARD; holds the live definitions. */
const REPAIR = "20261005090300_signature_and_contract_gate_repair.sql";
...
describe("engineering signature provenance", () => {
  ...
  it("is the only thing in the chain that writes a signature column", () => {
    ...
    // 20260809140000 defines the original RPC, which 20261005090100 and then
    // 20261005090300 replace; its text is still in the chain, superseded.
