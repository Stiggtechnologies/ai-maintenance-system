...
updated 2026-07-08 after the July hardening campaign (PRs #2–#20)._
...
| LLM intelligence              | **✅ Live**     | OpenAI copilot with GPT-parity prompt + mandatory RAG citations (DoD RAM Guide / MIL-HDBK-338B); Gemini enrichment loop; AI onboarding deduction with confidence-gated HITL demotion.                  |
