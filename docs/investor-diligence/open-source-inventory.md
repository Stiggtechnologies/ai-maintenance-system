...
- Lockfile SHA-256: `3d49fd7a1c5685b99105e2f3f3e1e039c71aeed56fbb679dd15638be2c624c2d`
- Package instances: **424**
...
| MIT | 330 | Permitted by automated baseline |
...
| @types/react-dom | 19.2.7 | development | MIT |
...
| eslint-plugin-react-refresh | 0.5.6 | development | MIT |
| eslint | 10.10.0 | development | MIT |
| fflate | 0.8.3 | production | MIT |
| framer-motion | 12.43.0 | production | MIT |
| globals | 17.12.0 | development | MIT |
| husky | 9.1.7 | development | MIT |
| jsdom | 29.1.1 | development | MIT |
| lint-staged | 17.5.0 | development | MIT |
...
| typescript-eslint | 8.69.0 | development | MIT |
