...
- Lockfile SHA-256: `eb9d42b7f28a51d5008e5baaea7a99c3add03d2198efcc2a8d001159e03105d6`
...
| @supabase/supabase-js | 2.116.0 | production | MIT |
...
| lucide-react | 1.45.0 | production | ISC |
...
| react-dom | 19.3.0 | production | MIT |
| react-router-dom | 7.18.3 | production | MIT |
| react | 19.3.0 | production | MIT |
