...
**Not in scope, deliberately:** correcting `ISO-55000-IMPLEMENTATION-SUMMARY.md` (§4.15) was more urgent than this entire IA and belonged in its own change — it was deleted on 2026-08-20. `20260909090000_ops_coordination_asset_id.sql` post-dates and redefines `get_ops_coordination()`; the `:85`/`:171` role gates are unchanged — verified.
