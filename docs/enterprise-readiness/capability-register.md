...
| C2.04 | Process historian, alarms, trips, operating context                              | 🟡 operating_states (running/idle/standby/down/offline with load), production_records and process_events modelled, all three accepted by the slice-14 ingest contract with validation, idempotency and retained rejects (migration 20260812090000). No live feed yet — and an asset with no state record is never treated as running                                                                                                                                                              |
...
never changed, only the count of it). Current tally: ✅ 86 · 🟡 109 · ❌ 202. _(2026-08-07: reconciled after parallel merges — C7.01/03/04/11 reliability engine, C4.13–17 + C6.22 closed-loop tail, C3.01–12 taxonomy, C5.04 scheduler all verified present on main.)_
