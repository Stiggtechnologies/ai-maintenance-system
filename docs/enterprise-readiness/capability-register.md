...
| ID    | Capability                                                                                            | Status                                                                                                                                                                                                                                                                                                                        |
| ----- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C9.01 | Stage 1: one area — clean data, work history, KPI baseline, bad actors                                | ✅ two independent real fleets loaded: 26 AHS haul units (6,000 WOs) and 144 auxiliary units (20,314 WOs, 21,450 state records). Bad actors identified on evidence — undercarriage at 32,394 h from 458 events is the largest single loss, while ground-engaging tools lead on COUNT and would have misdirected the programme |
...
| U21.02 | Self-serve fleet-history onboarding: upload a downtime/work-history export, profile it, propose a column and vocabulary mapping for human review, preview what will load and what will be rejected, then load through the validated ingest contract | 🟡 built into the asset-onboarding capability (src/lib/fleet-import, 18 tests; migration 20260813140000). Proposes and never decides: mapping, vocabulary and a full accept/reject preview are confirmed by a person before anything is written, and the confirmed judgements are stored with the profile they were shown. CSV only — .xlsx needs a parsing dependency, which is a supply-chain decision to take on its own merits |
...
never changed, only the count of it). Current tally: ✅ 89 · 🟡 110 · ❌ 199. _(2026-08-07: reconciled after parallel merges — C7.01/03/04/11 reliability engine, C4.13–17 + C6.22 closed-loop tail, C3.01–12 taxonomy, C5.04 scheduler all verified present on main.)_
