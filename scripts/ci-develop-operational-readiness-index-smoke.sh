...
echo 'D8.11 operational-readiness index smoke passed: governed weights, exact category coverage, hard override, tenancy, evidence, immutability and no invented defaults'
